...
var visitor = ua(process.env.SPACETRADERS_ANALYTICS_UA || 'UA-100088262-1', anonId, {
...
module.exports = function(action, label, duration) {
  return new Promise(function(resolve) {
    ...
    if (configstore.get('tokens') && configstore.get('usage')) {
      visitor.event('Spacetraders CLI ' + pkg.version, action, label, duration).send(function() {
