...
var _request = function(options) {
  ...
  return new Promise(function(resolve, reject) {
    var req = request(options, function(err, response, body) {
      if (err) {
        return reject(new SpaceTradersError('Server Error. ' + err.message, {
          original: err,
          exit: 2
        }));
      }
...
var api = {
  ...
  clientId: utils.envOverride('FIREBASE_CLIENT_ID', '888244626444-ntm90pnqlv4h6nnkn8tqv0qfflnsev8h.apps.googleusercontent.com'),
  clientSecret: utils.envOverride('FIREBASE_CLIENT_SECRET', 'FolVjrlAkeLPTPHaKLisrf0H'),
  ...
  getProject: function(projectId) {
    return api.request('GET', '/v1/projects/' + encodeURIComponent(projectId), {
      ...
      return Promise.reject(new SpaceTradersError('Server Error: Unexpected Response. Please try again', {
        context: res,
        exit: 2
      }));
    });
